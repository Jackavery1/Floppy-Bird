...
export const FONT_SIZE_TINY = FONT_SIZE_SMALL;
...
/** Titres overlay (pause). */
export const FONT_SIZE_TITLE = '18px';
/** Score / titre jeu (fitTitle). */
export const FONT_SIZE_DISPLAY = '22px';
/** Score HUD en partie. */
export const FONT_SIZE_SCORE = '28px';
